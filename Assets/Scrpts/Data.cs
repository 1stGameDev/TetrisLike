...
public static class Data
{
    ...
    private static readonly Vector2Int[,] WallKicksI = new Vector2Int[,] {
        { new Vector2Int(0, 0), new(-2, 0), new( 1, 0), new(-2,-1), new( 1, 2) },
        { new Vector2Int(0, 0), new( 2, 0), new(-1, 0), new( 2, 1), new(-1,-2) },
        { new Vector2Int(0, 0), new(-1, 0), new( 2, 0), new(-1, 2), new( 2,-1) },
        { new Vector2Int(0, 0), new( 1, 0), new(-2, 0), new( 1,-2), new(-2, 1) },
        { new Vector2Int(0, 0), new( 2, 0), new(-1, 0), new( 2, 1), new(-1,-2) },
        { new Vector2Int(0, 0), new(-2, 0), new( 1, 0), new(-2,-1), new( 1, 2) },
        { new Vector2Int(0, 0), new( 1, 0), new(-2, 0), new( 1,-2), new(-2, 1) },
    ...
    private static readonly Vector2Int[,] WallKicksJLOSTZ = new Vector2Int[,] {
        { new Vector2Int(0, 0), new(-1, 0), new(-1, 1), new(0,-2), new(-1,-2) },
        { new Vector2Int(0, 0), new( 1, 0), new( 1,-1), new(0, 2), new( 1, 2) },
        { new Vector2Int(0, 0), new( 1, 0), new( 1,-1), new(0, 2), new( 1, 2) },
        { new Vector2Int(0, 0), new(-1, 0), new(-1, 1), new(0,-2), new(-1,-2) },
        { new Vector2Int(0, 0), new( 1, 0), new( 1, 1), new(0,-2), new( 1,-2) },
